...
function ListingsTable({ data, preferences }) {
    ...
    const [dogSize, setDogSize] = useState(preferences.size_preference.split(""));
    const [walks, setWalks] = useState(preferences.walker_30wo !== 1 ? true : false);
    const [homeVisit, setHomeVisit] = useState(preferences.walker_30hv !== 1 ? true : false)
    ...
    const filterBookings = () => {
        ...
        const filteredData = data.filter((booking) => {
            ...
            if (geokit.distance(preferencesLocation, bookingLocation) > distanceFromWalker) return false;
            if (!dogSize.includes(booking.dog_size)) return false;
            if (!walks && booking.service_type === "30WO" || !walks && booking.service_type === "60WO") return false;
            if (!homeVisit && booking.service_type === "30HV" || !homeVisit && booking.service_type === "60HV") return false;
        ...
        <div className="listings-container">
            <div className="preferences-container">
                ...
                <SelectDropdownNoForm
                    id="distance"
                    name="distance"
                    onChange={(e) => setDistanceFromWalker(Number(e.currentTarget.value))}
                ...
                <div className="preferences-dog-size">
                    ...
                    <div className="preference-checkbox-container">
                        ...
                        <div className="container-checkbox">
                            <label className="container-checkbox"> Small
                                <input
                                    type="checkbox"
                                    name={"dogSize"}
                        ...
                        <div className="container-checkbox">
                            <label className="container-checkbox"> Medium
                                <input
                                    type="checkbox"
                                    name={"dogSize"}
                        ...
                        <div className="container-checkbox">
                            <label className="container-checkbox"> Large
                                <input
                                    type="checkbox"
                                    name={"dogSize"}
                ...
                <div className="preferences-service-type">
                    ...
                    <div className="preference-checkbox-container">
                        <div className="container-checkbox">
                            <label className="container-checkbox"> Walks
                                <input
                                    type="checkbox"
                                    name={"walks"}
                        ...
                        <div className="container-checkbox">
                            <label className="container-checkbox"> Home Visits
                                <input
                                    type="checkbox"
                                    name={"homeVisits"}
